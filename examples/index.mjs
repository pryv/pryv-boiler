// Example with "await" at the top level.

import  path  from 'path';
import { fileURLToPath } from 'url';
// __dirname is not availble is ES 5 modules
const __dirname = path.dirname(fileURLToPath(import.meta.url));

import pluginSync from './plugins/plugin-sync.js';
import pluginASync from './plugins/plugin-async.js';

import boiler from '../src/index.js';
const {config, getLogger} = await boiler.ainit({
  appName: 'sample',
